...
public class MainActivity extends AppCompatActivity {
    ...
    private static final String USGS_REQUEST_URL =
            "https://earthquake.usgs.gov/fdsnws/event/1/query?format=geojson&starttime=2020-01-01&minmagnitude=7";
        ...
        private String makeHttpRequest(URL url) throws IOException {
            ...
            try {
                ...
                if (urlConnection.getResponseCode() == 200) {
                    ...
                    Log.e(LOG_TAG, "response code from the server is : " + urlConnection.getResponseCode());
                    throw new IOException();
                }

            } catch (IOException e) {
                Log.e(LOG_TAG, "Problem retrieving the json result due to internet problem      ", e);
            } finally {
